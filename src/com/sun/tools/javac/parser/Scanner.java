...
import com.akito.util.JInfo;
import com.akito.util.JTokenInfo;
...
public class Scanner implements Lexer {
    ...
    /** The last col of the previous token
     */
    ...
    public void nextToken() {
        ...
        try {
        	...
        	JTokenInfo info = new JTokenInfo(token, row, prevEndCol);
        	JInfo.getInstance().add(info);;
            endPos = bp;
            if (scannerDebug)
